...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      person_pavel_bio: "I take every brief personally — from the first call to the final frame. I keep my finger on the pulse of every process.",
      person_daniel_name: "Daniil Kravchenko",
      person_daniel_role: "CG Generalist, 3D Guru / Art Director",
      person_daniel_bio: "Full-CG generalist and art director — shaping worlds end to end, from look-dev to final 3D.",
      person_narek_name: "Narek Khachaturyan",
      person_narek_role: "Director / Editor",
      person_narek_bio: "Director and editor across commercials, music videos, documentaries, and feature films — bringing story and rhythm to every cut.",
      ...
      privacy_notice: "We use Cloudflare Web Analytics to measure aggregate visits, including pages, referrers, approximate country, device type, and performance. It does not use cookies, analytics localStorage, or individual fingerprinting. When you send the contact form, your name, email address, and message are delivered to our studio inbox via FormSubmit and used only to reply to your inquiry. Theme, language, and interface preferences are saved only in your browser.",
    ...
    ru: {
      ...
      person_pavel_bio: "Каждый проект веду лично — от первого созвона до финального кадра. Держу руку на пульсе всех процессов.",
      person_daniel_name: "Даниил Кравченко",
      person_daniel_role: "CG-дженералист, 3D-гуру / арт-директор",
      person_daniel_bio: "CG-дженералист и арт-директор — собираю картинку целиком, от лукдева до финального 3D.",
      person_narek_name: "Нарек Хачатурян",
      person_narek_role: "Режиссёр / режиссёр монтажа",
      person_narek_bio: "Режиссёр и монтажёр — рекламные ролики, клипы, документальное кино и полный метр. Держу историю и ритм в каждой склейке.",
      ...
      privacy_summary: "Конфиденциальность",
      privacy_notice: "Мы используем Cloudflare Web Analytics для агрегированной статистики посещений: страницы, источники переходов, примерная страна, тип устройства и скорость загрузки. Сервис не использует cookies, localStorage для аналитики или цифровые отпечатки посетителей. При отправке контактной формы ваши имя, адрес электронной почты и сообщение доставляются в почтовый ящик студии через FormSubmit и используются только для ответа на ваш запрос. Настройки темы, языка и интерфейса сохраняются только в вашем браузере.",
    ...
    zh: {
      ...
      person_pavel_bio: "每个项目我都亲自跟进——从第一次沟通到最终成片。全程掌控每个环节的节奏。",
      person_daniel_name: "Daniil Kravchenko",
      person_daniel_role: "CG 全能艺术家，3D 大师 / 艺术总监",
      person_daniel_bio: "全流程 CG 全能艺术家兼艺术总监——从概念设定到最终 3D，一手打造完整画面。",
      person_narek_name: "Narek Khachaturyan",
      person_narek_role: "导演 / 剪辑师",
      person_narek_bio: "导演兼剪辑师——广告片、音乐视频、纪录片到院线长片，为每一次剪辑注入故事与节奏。",
      direct_email: "直接邮箱:",
      ...
      privacy_summary: "隐私",
      privacy_notice: "我们使用 Cloudflare Web Analytics 统计汇总访问数据，包括页面、来源网站、大致国家或地区、设备类型和性能。该服务不使用 Cookie、用于分析的 localStorage，也不会对访客进行个人指纹识别。提交联系表单时，您的姓名、电子邮件地址和留言将通过 FormSubmit 发送至我们工作室的邮箱，仅用于回复您的咨询。主题、语言和界面偏好仅保存在您的浏览器中。",
      placeholder_name: "姓名",
      placeholder_email: "hello@company.com",
    ...
    ja: {
      ...
      person_pavel_bio: "最初の打ち合わせから最終カットまで、すべての案件を私自身が担当します。全工程の流れをしっかり把握しています。",
      person_daniel_name: "Daniil Kravchenko",
      person_daniel_role: "CG ジェネラリスト、3D の達人 / アートディレクター",
      person_daniel_bio: "フルCGジェネラリスト兼アートディレクター。ルックデブから最終3Dまで、世界観を一貫して作り上げます。",
      person_narek_name: "Narek Khachaturyan",
      person_narek_role: "監督 / 編集",
      person_narek_bio: "監督兼エディター。CM、ミュージックビデオ、ドキュメンタリー、長編映画まで手がけ、すべてのカットに物語とリズムを与えます。",
      direct_email: "直通メール:",
      ...
      privacy_summary: "プライバシー",
      privacy_notice: "当サイトでは Cloudflare Web Analytics を使用し、閲覧ページ、参照元、おおよその国、デバイスの種類、パフォーマンスなどの訪問状況を集計しています。Cookie、解析用 localStorage、個人を識別するフィンガープリントは使用しません。お問い合わせフォームを送信すると、氏名、メールアドレス、メッセージは FormSubmit を通じてスタジオの受信トレイに届き、お問い合わせへの返信にのみ使用されます。テーマ、言語、インターフェースの設定はブラウザ内にのみ保存されます。",
    ...
    fr: {
      ...
      person_pavel_bio: "Je prends chaque brief personnellement — du premier appel à l’image finale. Je garde le doigt sur le pouls de l’ensemble du processus.",
      person_daniel_name: "Daniil Kravchenko",
      person_daniel_role: "Généraliste CG, gourou de la 3D / directeur artistique",
      person_daniel_bio: "Généraliste CG et directeur artistique — je façonne l’image de bout en bout, du look-dev au 3D final.",
      person_narek_name: "Narek Khachaturyan",
      person_narek_role: "Réalisateur / monteur",
      person_narek_bio: "Réalisateur et monteur — publicités, clips, documentaires et longs métrages, apportant récit et rythme à chaque montage.",
      ...
      privacy_summary: "Confidentialité",
      privacy_notice: "Nous utilisons Cloudflare Web Analytics pour mesurer les visites de façon agrégée : pages consultées, sites référents, pays approximatif, type d’appareil et performances. Ce service n’utilise ni cookies, ni localStorage analytique, ni empreinte numérique individuelle. Lorsque vous envoyez le formulaire de contact, votre nom, votre adresse e-mail et votre message sont transmis via FormSubmit jusqu’à la boîte mail du studio et ne servent qu’à répondre à votre demande. Les préférences de thème, de langue et d’interface restent enregistrées uniquement dans votre navigateur.",
  ...
  if (contactForm && statusMsg) {
    contactForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (!response.ok) throw new Error(`Form service responded with HTTP ${response.status}`);

        // Only claim success once the mail service confirmed delivery.
        statusMsg.textContent = translations[currentLang].form_success;
        statusMsg.className = 'form-status-msg success';
        contactForm.reset();
      } catch (err) {
        // Keep the visitor's input so they can retry without retyping.
